...
import com.mmu.shuttle.backend.securities.CustomAuthenticationEntryPoint;
import com.mmu.shuttle.backend.securities.CustomUserDetailsService;
import com.mmu.shuttle.backend.securities.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/announcements/all").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/routes/web").permitAll()
